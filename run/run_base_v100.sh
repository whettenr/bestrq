...
torchrun --nproc_per_node=8 --rdzv_backend c10d --rdzv-endpoint=localhost:0 train.py hparams/best_rq_base.yaml --find_unused_parameters --bfloat16_mix_prec=false
